...
public final class FindMeetingQueryTest {
  ...
  public void noRoomForOptionalAttendee() {
    ...
    MeetingRequest request = new MeetingRequest(Arrays.asList(), Arrays.asList(PERSON_A, PERSON_B), DURATION_30_MINUTES);
  ...
  public void noMandatoryAttendeesWithGaps() {
    ...
    // Events  : |--A--|     |--B--|      |----B----|
    // Day     : |----------------------------------|
    // Options : |--BO-|-ABO|--AO--|--ABO-|----AO---|

    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TIME_0930AM, true),
            Arrays.asList(PERSON_B)),
    ...
    Collection<TimeRange> expected =
        Arrays.asList(TimeRange.fromStartDuration(TIME_0830AM, DURATION_30_MINUTES),
        TimeRange.fromStartDuration(TIME_0930AM, TIME_1100AM));
